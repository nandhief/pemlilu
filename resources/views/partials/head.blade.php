...
<link rel="stylesheet" href="{{ url('assets/css') }}/quickadmin-layout.css"/>
<link rel="stylesheet" href="{{ url('assets/css') }}/quickadmin-theme-default.css"/>
<link rel="stylesheet" href="{{ url('assets/css') }}/select2.min.css"/>
<link rel="stylesheet" href="{{ url('assets/css') }}/jquery-ui.min.css">
<link rel="stylesheet" href="{{ asset('datatables') }}/css/jquery.dataTables.min.css"/>
<link rel="stylesheet" href="{{ asset('datatables/extension') }}/css/select.dataTables.min.css"/>
